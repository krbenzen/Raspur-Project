 ...
 *
 * Description:
 * This class represents a Beach Fish Student NPC within the beach portion of the map. It extends the
 ...
 *
 * ISA: BeachFishStudent IS-A Entity
 * HASA: BeachFishStudent has-a String question
...
public class BeachFishStudent extends Entity {
    ...
    /** 
     * Constructs a new BeachFishStudent NPC.
     *
     ...
     */
    public BeachFishStudent(GamePanel gamePanel, String question, String[] answers, int correctAnswer) {
        super(gamePanel);
    ...
    public void setDialogue() {
        ...
        dialogues[1] = "Blub blub blub\nblub blub blub\nblub!";
        dialogues[2] = "Blub blub....";
        dialogues[3] = "Blub blub blub?\nBlub blub!?!";
        dialogues[4] = "Blub! blub blub.";
        dialogues[5] = "Blub blub blub\nblub blub blub\nblub!";
        dialogues[6] = "Blub blub....";
        dialogues[7] = "Blub blub blub!\n BLUB!";
    ...
    public void speak() {
        if (puzzleCompleted) {
            ...
            gamePanel.ui.showMessage("Blub blub!");
