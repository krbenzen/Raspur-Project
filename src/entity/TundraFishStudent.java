 ...
 *
 * Description:
 * This class represents a Tundra Fish Student NPC within the Tundra portion of the map. It extends the
 ...
 *
 * ISA: TundraFishStudent IS-A Entity
 * HASA: TundraFishStudent has-a String question
...
public class TundraFishStudent extends Entity {
    ...
    /** 
     * Constructs a new TundraFishStudent NPC.
     *
     ...
     */
    public TundraFishStudent(GamePanel gamePanel, String question, String[] answers, int correctAnswer) {
        super(gamePanel);
